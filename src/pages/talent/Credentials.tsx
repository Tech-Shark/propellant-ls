                    ...
                    <CardContent className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <Select value={newCredential.type}
                            ...
                            <div>
                                ...
                                <Select value={newCredential.category} onValueChange={(value) => setNewCredential({
                                    ...newCredential,
                                    category: value
                                })}>
                                    <SelectTrigger className="bg-slate-800 border-slate-600 text-white">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex flex-col space-y-3">
                                <Label htmlFor="visibility" className="text-slate-300">Credential Visibility</Label>
                                ...
                                <Button
                                    ...
                                    className={`${newCredential.visibility ? 'bg-green-600 text-white' : 'bg-slate-800 text-slate-400'} border-slate-600  hover:text-white`}
                                >
                                        ...
                                        <div className="flex-1">
                                            <div className="flex items-center gap-2 mb-2">
                                                ...
                                                <Badge variant="secondary"
                                                       className={getStatusColor(credential.verificationStatus)}>

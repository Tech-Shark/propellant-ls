...
export default function Profile() {
  ...
  const handleSave = async () => {
    ...
    const updateProfilePromise = axiosInstance.patch(
      "users/profile",
      updatedUser
    );
  ...
  const handleSkillInputKeyDown = (e) => {
    if (e.key === "Enter" || e.key === ",") {
      ...
      if (
        newSkill &&
        (!profileData.skills || !profileData.skills.includes(newSkill))
      ) {
        setProfileData({
          ...profileData,
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-slate-400">
                Manage your professional profile and NFT badges
              </p>
            </div>
          </div>
                ...
                <div className="flex flex-wrap gap-2 mt-2">
                  {profileData.skills?.map((skill) => (
                    <Badge
                      key={skill}
                      variant="secondary"
                      className="bg-blue-600/20 text-blue-400 border-blue-600/30 flex items-center"
                    >
                      {skill}
                      <button
                        type="button"

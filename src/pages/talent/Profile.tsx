...
import { User, Camera, Award, Star, MapPin, Mail, Phone, Globe, Save, Share } from "lucide-react";
...
export default function Profile() {
  ...
  const [profileData, setProfileData] = useState({
    ...
    bio: 'Passionate frontend developer with 5+ years of experience building scalable web applications using React, TypeScript, and modern web technologies.',

                  ...
                  <div>
                    ...
                    <Select value={paymentMethod} onValueChange={setPaymentMethod}>
                      ...
                      <SelectContent className="bg-slate-800 border-slate-600">
                        <SelectItem value="card" className="text-white hover:bg-slate-700">Credit/Debit Card</SelectItem>
                        ...
                        <div>
                          ...
                          <Select value={billingInfo.country} onValueChange={(value) => setBillingInfo({...billingInfo, country: value})}>
                            ...
                            <SelectContent className="bg-slate-800 border-slate-600">
                              ...
                              <SelectItem value="ca" className="text-white hover:bg-slate-700">Canada</SelectItem>
                              <SelectItem value="au" className="text-white hover:bg-slate-700">Australia</SelectItem>
                            </SelectContent>
                          </Select>
                        </div>
                      </div>

...
const PrivacyPolicy = () => (
  <div className="max-w-3xl mx-auto p-4 sm:p-6 bg-white rounded-lg shadow-lg text-gray-800 text-base break-words">
    <h1 className="text-3xl font-bold mb-4 text-center">
      Privacy Policy for Propellant HR
    </h1>
    ...
    <ul className="list-disc pl-6 mb-4">
      ...
      <li>
        <strong>Application</strong> refers to Propellant HR, the software
        program provided by the Company.
      </li>
      <li>
        <strong>Company</strong> (referred to as either "the Company", "We",
        "Us" or "Our" in this Agreement) refers to Propellant HR, Uyo, Akwa Ibom
        Nigeria.
      </li>
      <li>
      ...
      <li>
        <strong>Website</strong> refers to Propellant HR, accessible from{" "}
        <a
          href="https://propellanthr.com"
          target="_blank"
    ...
    <ul className="list-disc pl-6 mb-4">
      <li>By email: hr@propellanthr.com</li>
    </ul>
  </div>
);

...
const Login = () => {
  ...
  // Always set role as TALENT - organization accounts are created via admin
  ...
  // These functions are kept for reference but no longer used in the UI
  // since we've removed the role selection and always set role to TALENT
        ...
        <Card className="bg-slate-900 border-slate-700 shadow-2xl">
          <CardHeader className="text-center pb-6">
            ...
            <CardTitle className="text-2xl text-white">
              {isSignUp ? "Create Your Talent Account" : "Welcome Back"}
            </CardTitle>
            <CardDescription className="text-slate-400 text-lg">
              {isSignUp
                ? "Start your verified career journey with Propellant"
          ...
          <CardContent className="space-y-6">
            <form onSubmit={handleSubmit} className="space-y-6">
              {/* Role Selection - Removed to automatically set as talent */}
            ...
            <div className="text-center space-y-4">
              ...
              <div className="text-xs text-slate-500 mt-4 pt-2 border-t border-slate-700">

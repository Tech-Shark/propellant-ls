...
import { Eye, ExternalLink, FileText, User, X } from "lucide-react";
import { getExplorerAddressUrl, getExplorerTransactionUrl } from "@/lib/utils";
...
const RejectedContent = ({
  ...
  return (
    <Card className="bg-slate-900 border-slate-700">
      <CardHeader>
        <CardTitle className="text-white">Rejected Credentials</CardTitle>
                      ...
                      <DialogContent className="bg-slate-900 border-slate-700 max-w-2xl">
                        <DialogHeader>
                          ...
                          <DialogDescription className="text-slate-400">
                            This credential was rejected. See the details and

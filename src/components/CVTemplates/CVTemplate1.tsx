        ...
        <div className="min-h-screen bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20">
                ...
                <header className="mb-16 lg:mb-24">
                    <h1 className="font-montserrat font-bold text-4xl sm:text-5xl lg:text-6xl xl:text-[64px] text-neutral-1000 leading-tight tracking-[-0.02em]">
                        Cameron Williamson
                    </h1>
                </header>
                        ...
                        <section>
                            ...
                            <div className="space-y-12">
                                ...
                                <div className="space-y-4">
                                    <p className="font-montserrat font-bold text-lg sm:text-xl text-neutral-600 leading-relaxed tracking-[-0.02em]">
                                        2000 - 2001
                                    </p>
                                    <h3 className="font-montserrat font-bold text-xl sm:text-2xl lg:text-[28px] text-neutral-1000 leading-tight tracking-[-0.02em]">

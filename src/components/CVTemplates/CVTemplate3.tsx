            ...
            <div className="min-h-screen bg-white">
                <div className="max-w-4xl mx-auto px-6 sm:px-8 lg:px-12 py-12 sm:py-16 lg:py-20">
                    ...
                    <header className="text-center mb-12 sm:mb-16 lg:mb-24">
                        <h1 className="font-montserrat font-bold text-black text-3xl sm:text-4xl md:text-5xl lg:text-6xl leading-tight tracking-tight">
                            Cameron Williamson
                        </h1>
                    </header>
                    ...
                    <div className="space-y-12 sm:space-y-16 lg:space-y-20">
                        ...
                        <section>
                            ...
                            <p className="font-inter text-[#606060] text-lg sm:text-xl lg:text-2xl leading-relaxed tracking-tight">
                        ...
                        <section>
                            ...
                            <div className="space-y-6 lg:space-y-8">
                                ...
                                <div className="space-y-3 lg:space-y-4">
                                    <p className="font-montserrat font-bold text-[#606060] text-base sm:text-lg lg:text-xl leading-relaxed tracking-tight">
                                        January 2000 - November 2001
                                    </p>
                                    <h3 className="font-montserrat font-bold text-black text-xl sm:text-2xl lg:text-3xl leading-tight tracking-tight">
                        ...
                        <section>
                            ...
                            <div className="space-y-6 lg:space-y-8">
                                ...
                                <div className="space-y-3 lg:space-y-4">
                                    ...
                                    <h3 className="font-montserrat text-black text-xl sm:text-2xl lg:text-3xl leading-tight tracking-tight">
